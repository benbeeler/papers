...
%DIF DEL frontiers_old.tex   Fri Mar  5 15:45:52 2021
%DIF ADD frontiers.tex       Mon Mar  8 09:14:06 2021
...
%DIF -------
\def\Authors{Benjamin Beeler\,$^{1,2,*}$, Khadija Mahbuba\,$^{1}$, Yuhao Wang\,$^{3}$, and Andrea Jokisaari\,$^{1,2}$} %DIF > 
%DIF -------

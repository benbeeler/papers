...
%DIF DEL old.tex        Fri Feb 21 15:27:49 2025
%DIF ADD template.tex   Fri Feb 21 20:24:56 2025
...
(\textit{c}) Regime III: Under even higher stresses, the relation between $v$ and $\tau$ becomes nonlinear due to a combination of phonon and radiative damping, and the velocity asymptotically approaches the transverse sound velocity \cite{Dang2019}. Radiative damping arises from \DIFdelbegin \DIFdel{the }\DIFdelend \DIFaddbegin \DIFadd{wave }\DIFaddend emission (radiation) \DIFdelbegin \DIFdel{of waves }\DIFdelend by dislocations during their motion and is independent of temperature. \DIFdelbegin \DIFdel{Although }\DIFdelend \DIFaddbegin \DIFadd{In systems failing by cracking, such as nuclear fuels under extreme conditions, energy dissipation primarily occurs through the formation of new crack surfaces rather than dislocation motion, as crack propagation typically occurs at velocities insufficient for radiative damping \cite{Kresse2004}. Consequently, radiative damping is more relevant in high-velocity deformation scenarios, such as shock loading rather than in cracking-induced failures \cite{Kresse2004}. Additionally, the stress field around a propagating crack can hinder long-range dislocation movement, influencing the energy dissipation mechanisms in these systems \cite{Kresse2004}. Thus, although }\DIFaddend we identify the transition stress \DIFdelbegin \DIFdel{, $\tau_t'$, }\DIFdelend between Regimes II and III, \DIFaddbegin \DIFadd{$\tau_t'$, }\DIFaddend Regime III is not handled in this study \DIFdelbegin \DIFdel{, }\DIFdelend and the fitted mobility function is restricted to Regimes I and II.

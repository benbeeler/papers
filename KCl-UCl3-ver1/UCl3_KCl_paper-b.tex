...
Can \textit{et al.} collected experimental data and developed models of the KCl-UCl$_3$ thermophysical properties based on a Redlich-Kister expansion~\cite{agca2022}. Kim \text{et al.}~\cite{Kim} used molecular dynamics (MD) simulations to calculate the density, heat capacity, and viscosity of KCl-UCl$_3$ mixtures. 
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.45\textwidth]{KCl.pdf}
\caption{Calculated density of KCl as a function of temperature obtained using different methods to describe dispersion force interactions (DFT-dDsC and DFT-D3), compared to experimental data (Moon \textit{et al.}~\cite{Moon} and Duemmler \textit{et al.}~\cite{DUEMMLER2022153414}) or correlations (Janz~\cite{Janz1988}). The computational data from 
...
\begin{figure*}[htb]
\centering
\includegraphics[width=0.45\textwidth]{KCl_UCl3_energy.pdf} \includegraphics[width=0.45\textwidth]{NaCl_UCl3_energy.pdf}

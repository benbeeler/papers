...
%DIF DEL umo_interfaces4.tex   Thu Apr 12 12:58:15 2018
%DIF ADD umo_interfaces5.tex   Mon Apr 23 12:03:43 2018
\usepackage{hyperref}
...
%DIFDELCMD <  \centering
%DIFDELCMD <  \includegraphics[width=0.8\textwidth]{ben1.png} 
%DIFDELCMD <  %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{Schematic of U-Mo monolithic fuel cross section. Not to scale.}}
 %DIFAUXCMD
%DIFDELCMD < \label{fig:ben1}
...
\begin{figure}[h]
 \centering
 \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.6\textwidth]{uvsmo600.png} 
%DIFDELCMD <  %%%
...
\begin{figure}[h]
 \centering
 \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.6\textwidth]{uvsmo1200.png} 
%DIFDELCMD <  %%%
...
\begin{figure}[h]
 \centering
 \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.6\textwidth]{avg_vs_mo.png} 
%DIFDELCMD <  %%%
...
\begin{figure}[h]
 \centering
 \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.6\textwidth]{umosurf600.png} 
%DIFDELCMD <  %%%
...
\begin{figure}[h]
 \centering
 \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.6\textwidth]{umosurf1200.png} 
%DIFDELCMD <  %%%
...
\begin{figure}[h]
 \centering
 \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.6\textwidth]{umoavgsurf.png} 
%DIFDELCMD <  %%%

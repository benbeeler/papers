...
\centering
\includegraphics[width=0.9\textwidth]{fig3.jpg}
\caption{The predicted density of states for simulations of AFM molten UCl$_3$ at 1250 K, a) not including a Hubbard $U$ model, and b) a Hubbard U value of 4 eV. {\color{red}The density of states are ensemble averages of XX steps.}}
\label{fig:DOS}
\end{figure*}

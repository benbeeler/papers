...
\begin{equation}
\begin{split}
E_{mix}(x,T)=(e_1+e_2T)x(1-x)+(e_1+e_2T)x(1-x)(2x-1) %+(h_1+h_2T)x^3+(i_1+i_2T)x^4\\
%+(j_1+j_2T)x^5,
\label{eq:LSE}
\end{split}
\end{equation}

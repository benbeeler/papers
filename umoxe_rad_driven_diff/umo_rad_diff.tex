...
\begin{figure}[h]
 \centering
 \includegraphics[width=1.0\textwidth]{5_msdT.png} 
...
\begin{figure}[h]
 \centering
 \includegraphics[width=0.7\textwidth]{6_A_comp.png} 
...
\begin{align}
 D_U = D_U(intrinsic) + 1.97\times10^{-41} * \dot{F} \label{eq3}  \\
 D_{Mo} = D_{Mo}(intrinsic) + 2.01\times10^{-41} * \dot{F} \label{eq4} \\
 D_{Xe} = D_{Xe}(intrinsic) + 5.07\times10^{-41} * \dot{F} \label{eq5}
\end{align}

\begin{figure}[h]
 \centering
 \includegraphics[width=0.8\textwidth]{7_total_diff.png} 

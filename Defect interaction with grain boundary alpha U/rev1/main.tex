...
\begin{figure}[h!]
\centering
\subfloat[]{\includegraphics[width = 0.7\textwidth]{1_Picture1.png}}\\
...
\begin{figure}[h!]
\centering
\subfloat[]{\includegraphics[width = 2.0in]{2_A_500_Inter.png}}
...
\begin{figure}[h!]
\centering
\subfloat[]{\includegraphics[width = 2.0in]{3_A_500_Vacan.png}} 
...
\begin{figure}[h!]
\centering
\subfloat[]{\includegraphics[width = 2.25in]{4_A_SE.png}}
\subfloat[]{\includegraphics[width = 2.25in]{4_B_SE.png}} 
\subfloat[]{\includegraphics[width = 2.25in]{4_C_SE.png}}\\
...
\begin{figure}[h!]
\centering
\subfloat[]{\includegraphics[width = 2.5in]{5_weighted_SI.png}} 
...
\begin{figure}[h!]
\centering
\subfloat[]{\includegraphics[width = 2.25in]{6_A_IL.png}}
\subfloat[]{\includegraphics[width = 2.25in]{6_B_IL.png}} 
\subfloat[]{\includegraphics[width = 2.25in]{6_C_IL.png}}\\
...
\begin{figure}[h!]
\centering
\subfloat[]{\includegraphics[width = 2.5in]{7_weighted_IL_SI.png}}
...
\begin{figure}[h!]
\centering
\subfloat[]{\includegraphics[width = 2.25in]{9_A2_diffusion.png}}
\subfloat[]{\includegraphics[width = 2.25in]{9_B2_diffusion.png}} 
\subfloat[]{\includegraphics[width = 2.25in]{9_C2_diffusion.png}}\\
...
\begin{figure}[h!]
\centering
\subfloat[]{\includegraphics[width = 2.8in]{10_final2.png}}
...
\begin{figure}[h!]
\centering
\subfloat[]{\includegraphics[height = 2.4in]{11_A_diffusion.png}}
\subfloat[]{\includegraphics[height = 2.4in]{11_B_diffusion.png}} 
\subfloat[]{\includegraphics[height = 2.4in]{11_C_diffusion.png}}\\
...
\begin{figure}[h!]
\centering
\subfloat[]{\includegraphics[width = 0.45\textwidth]{14_1_2.png}}
\subfloat[]{\includegraphics[width = 0.45\textwidth]{14_3.png}}\\
...
\begin{figure}[h!]
\centering
\subfloat[]{\includegraphics[width = 0.5\textwidth]{15_compensation.png}}\\
...
The crystal structure of $\alpha$-U is included in \Cref{fig:alphaU_struct} for reference.
...
\begin{figure}[h!]
\centering
\subfloat[]{\includegraphics[width = 3in]{A1_GB_I.png}} 
\subfloat[]{\includegraphics[width = 3in]{B1_GB_I.png}}\\ 
\subfloat[]{\includegraphics[width = 3in]{C1_GB_I.png}}
\subfloat[]{\includegraphics[width = 3in]{A2_GB_I.png}}\\ 
\subfloat[]{\includegraphics[width = 3in]{B2_GB_I.png}} 
\subfloat[]{\includegraphics[width = 3in]{C2_GB_I.png}}\\

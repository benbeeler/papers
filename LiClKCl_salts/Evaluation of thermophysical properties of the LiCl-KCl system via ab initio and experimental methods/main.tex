...
\begin{figure}[h]
 ...
 \caption{The density as a function of pressure at 1000 K for LiCl and KCl utilizing seven unique descriptions for the vdW forces, compared to experimental data from Janz \cite{janz1975molten,van1955electrical}}
 \label{fig:disp}
\end{figure} 
\end{comment}
